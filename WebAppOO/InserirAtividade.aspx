<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InserirAtividade.aspx.cs" Inherits="InserirAtividade" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:TextBox ID="_txtCodigo" runat="server" Width="74px"></asp:TextBox><br />
        <br />
        ...
        <asp:Label ID="_lblDescricao" runat="server" Font-Bold="True" Font-Names="Verdana"
            Font-Size="Small" Text="Descrição"></asp:Label>
        <br />
